...
We aggregate probe names negotiating expression of the same gene by maximum fold change (because Ingenuity does it wrong). 
...
# Append description
degs <- merge(degs, annot.f, by.x="Group.1", by.y="GeneName")
write.table(degs, "results/limma_MicroarrayClass_WithoutOutliers_WithoutBatch_IPA.txt", sep="\t")
```
