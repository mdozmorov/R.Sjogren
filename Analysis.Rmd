...
```{r pathwayEnrichment, echo=FALSE}
# Perform enrichment analysis of topTable produced by limma
...
```{r limma, echo=FALSE}
limmaOnData <- function(exprs, modFactor, fileName){ # Limma on the expression matrix and a level from meta
